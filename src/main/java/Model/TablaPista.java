...
public class TablaPista {
    ...
    public void prettyTable(JTable tabla) {
        // Obtener la tabla y el modelo de la primera tabla (Horizontal)
        JTable tablaHorizontal = tabla;
        TableColumnModel columnModelHorizontal = tablaHorizontal.getColumnModel();

        // Ajustar el ancho de las columnas
        columnModelHorizontal.getColumn(0).setPreferredWidth((int) (tablaHorizontal.getWidth() * 0.1));
        columnModelHorizontal.getColumn(1).setPreferredWidth((int) (tablaHorizontal.getWidth() * 0.9));

        // Centrar los elementos de la primera columna
